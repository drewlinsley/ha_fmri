function [stats,models,train_stats,train_lambda,p_vals] = train_model_jonas(input,X,num_toss,lambda,folds,null,lambda_folds)
        ...
        for y = 1:ns(2),
            ...
            if ~isnan(sum(it_ytest)),
                ...
                if null == true,
                    ...
                    it_pvals(x,y) = 1 - ((sum(it_corr(x,y) > perm_it_corr) + 1) ./ (num_iter + 1));
                end
            end
        end
    end
